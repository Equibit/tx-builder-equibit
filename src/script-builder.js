...
const hashTimelockContract = (redeemer, funder, commitment, locktime) => {
  const scriptAsm = normalizeScript(scripts.hashTimeLock(redeemer, funder, commitment, locktime))
