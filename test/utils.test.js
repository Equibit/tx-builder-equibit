...
describe('Utils', function () {
  const pubKeyHexStr = ['03a6afa2211fc96a4130e767da4a9e802f5e922a151c5cd6d4bffa80358dd1f9a3',
  ...
  const exectedEQBAddressMainNet = ['EQa9KRkUkfxvKnnukYoUzJbGjDZFiVBS5Njp', 'EQaSAN2AgibLnmo9AHtb1MYEbRfFSDbUy5aQ', 'EQaM2X75QtyF7r1mhP1bg5kjEXBvNWVgaHnp', 'EQaMtA1f4CPYThrYRjWQmPat7xfY8d5BnXSt']
  const expectedEQBAddressTestNet = ['TQaJyoNCGvMrZNWiyipKaVgLrPr3PESSf9cZ', 'TQabpjdtCxzH2MWxPTuRbYdJibx36xmnBm1T', 'TQaWgtinw9NBMRjavZ2SGGqoMhUi3FgB7RZ3', 'TQaXYXdNaSnUhHaMeuXFMafxF8xKoNEzgdyB']

  describe('getEquibitAddress (base58check public key hash)', function () {
    it('should return the expected value', function () {
      let pubKeyBufferHex
      let pubKeyListLength = pubKeyHexStr.length
